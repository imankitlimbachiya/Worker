...
public class TermsConditionsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("response", "## language :: "+ language);
                    ...
                    public void run() {
                        try {
                            ...
                            if (json_main.getString("success").equalsIgnoreCase("true")) {
                                webview.loadDataWithBaseURL(null, json_main.getString("TeamsAndConditions"), "text/html", "utf-8", null);
    ...
    protected void onResume() {
        if (Consts.getInstance().isNetworkAvailable(mContext)) {
            ...
            Consts.getInstance().Act_vity="term";
