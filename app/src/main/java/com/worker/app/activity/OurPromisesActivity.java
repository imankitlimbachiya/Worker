...
public class OurPromisesActivity extends BaseActivity {
    ...
    public void Init() {
        ...
        language = preferences.getString("language", "Arabic");
    }
                    ...
                    public void run() {
                        try {
                            ...
                            if (json_main.getString("success").equalsIgnoreCase("true")) {
                                webview.loadDataWithBaseURL(null, json_main.getString("OurPromisses"), "text/html", "utf-8", null);
//
                            } else {
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("language",preferences.getString("language",language));
    ...
    protected void onResume() {
        if (Consts.getInstance().isNetworkAvailable(mContext)) {
            ...
            Consts.getInstance().Act_vity="Ourpromise";
